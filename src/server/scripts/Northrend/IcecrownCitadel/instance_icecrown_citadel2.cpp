...
class instance_icecrown_citadel2 : public InstanceMapScript
{
    public:
        instance_icecrown_citadel2() : InstanceMapScript("instance_icecrown_citadel2", 631) { }

        struct instance_icecrown_citadel2_InstanceMapScript : public InstanceScript
        {
            instance_icecrown_citadel2_InstanceMapScript(InstanceMap* pMap) : InstanceScript(pMap)
            {
        ...
        {
            return new instance_icecrown_citadel2_InstanceMapScript(pMap);
        }
};

void AddSC_instance_icecrown_citadel2()
{
    new instance_icecrown_citadel2();
}
